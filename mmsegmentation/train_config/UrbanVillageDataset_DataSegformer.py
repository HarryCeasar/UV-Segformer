...
test_dataloader = dict(
    batch_size=1,
    dataset=dict(
        data_prefix=dict(img_path='spectras/test', seg_map_path='ann/test'),
        data_root='MultiDataset/MultiDataset',
        pipeline=[
...
train_dataloader = dict(
    batch_size=4,
    dataset=dict(
        data_prefix=dict(img_path='spectras/train', seg_map_path='ann/train'),
        data_root='MultiDataset/MultiDataset',
        pipeline=[
            dict(type='LoadSingleRSImageFromFile'),
            dict(type='LoadAnnotations'),
...
val_dataloader = dict(
    batch_size=1,
    dataset=dict(
        data_prefix=dict(img_path='spectras/val', seg_map_path='ann/val'),
        data_root='MultiDataset/MultiDataset',
        pipeline=[
            dict(type='LoadSingleRSImageFromFile'),
            dict(keep_ratio=True, scale=(
...
work_dir = './work_dirs/UrbanVillageDataset-DataSegformer'
