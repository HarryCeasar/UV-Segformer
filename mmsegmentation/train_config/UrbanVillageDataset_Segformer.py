...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root='MultiDataset/beijing',
        pipeline=[
...
train_dataloader = dict(
    batch_size=4,
    dataset=dict(
        data_prefix=dict(img_path='img/train', seg_map_path='ann/train'),
        data_root='MultiDataset/beijing',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations'),
...
work_dir = './work_dirs/XiamenDataset-Segformer'
