...
def featuredecision_init_model(config: Union[str, Path, Config],
    ...
    elif 'init_cfg' in config.model.backbone1:
        config.model.backbone1.init_cfg = None
        config.model.backbone2.init_cfg = None
        config.model.backbone3.init_cfg = None
    ...
    if checkpoint is not None:
        ...
        if 'dataset_meta' in checkpoint.get('meta', {}):
            ...
            num_classes = model.decode_head1.num_classes
            dataset_name = None
